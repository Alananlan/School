...
public class Exercises18HPQ {
	...
	public static void main(String[] args) {
		...
		HeapPriorityQueue<Integer> pq18 = new HeapPriorityQueue<Integer>(10);
		...
		HeapPriorityQueue<String> stringheap = new HeapPriorityQueue<>();
		stringheap.add("zero"); stringheap.add("one"); stringheap.add("two");
		System.out.println(stringheap);

		stringheap.remove("two");
		System.out.println(stringheap);
