...
public class Winter2021Final {
	...
	public static void main(String[] args) {
		...
		System.out.println("count 42's = " + init.dataCount(42)); // 2
		...
		SortedLinkedList<Integer> tres = new SortedLinkedList<>();

		tres.add(5); tres.add(5);
		System.out.println(tres);

		tres.removeDuplicates();
		System.out.println("AFTER REMOVE " + tres);
		System.out.println(tres.dataCount(5));
